            ...
            <div class="tabBody mb10">
                <div class="bodyLi bodyActive">
                    <div class="win-input mb10">
                        ...
                        <input type="text" id="name" class="text-full" placeholder="请输入" value="${userUper.name}">
                    </div>

                    <div class="win-input mb10">
                        <span class="input-name">用户账号</span>
                        <input type="text" class="text-full" placeholder="请输入" disabled="value" value="${userUper.user_id}">
                    </div>
                    ...
                    <div class="win-input mb10">
                        ...
                        <div class="picture-box">
                            <div class="uploadImgBox">
                                <div class="imgBox">
                                    <img src="${userUper.portrait_path}${userUper.portrait_name}" alt=""> 
                                </div>
                               <div class="win-input mb10">
                    ...
                    <div class="win-input mb10">
                        ...
                        <div class="select-box">
                            <select class="select" disabled="value" value="${userUper.user_id}">
                                <c:if test="${userUper.grade eq 1}"><!-- 如果 -->
									<option value="" >游客</option>
								</c:if>
                                
                                 <c:if test="${userUper.grade eq 2}"><!-- 如果 -->
									<option value="" >${userUper.grade}级管理员</option>
								</c:if>
                               <c:if test="${userUper.grade eq 3}"><!-- 如果 -->
									<option value="" >${userUper.grade}级管理员</option>
								</c:if><c:if test="${userUper.grade eq 4}"><!-- 如果 -->
									<option value="" >${userUper.grade}级管理员</option>
								</c:if>
                            </select>
                        </div>
                    ...
                    <div class="win-input mb10">
                        ...
                        <input type="text" id="tel" class="text-full" placeholder="请输入" value="${userUper.tel}">
                    </div>
					<div class="win-input mb10">
                        <span class="input-name">用户部门</span>
                        <div class="select-box">
                            <select class="select"  disabled="value" value="${userUper.department}">
                               
                                <option value="" >${userUper.department}</option>
                    ...
                    <div class="win-input mb10">
                        ...
                        <input type="text" id="description" class="text-full" placeholder="请输入" value="${userUper.description}">
                    </div>

                    
                     <div class="win-input mb10">
                        <span class="input-name">密码</span>
                        <input type="password" id="password1" class="text-full" placeholder="请输入" value="${userUper.password}">
                    </div>
                    <div class="win-input mb10">
                        <span class="input-name">确认密码</span>
                        <input type="password" id="password2" class="text-full" placeholder="请输入" value="${userUper.password}">
                    </div>
                </div>
