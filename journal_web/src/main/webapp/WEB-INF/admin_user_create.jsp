	...
	{	
		...
		$.ajax({
            //几个参数需要注意一下
                ...
                url: "../journal_web/userCreateAction" ,//url
             	// 告诉jQuery不要去处理发送的数据
                processData : false, 
                ...
                success: 
                    ...
                    if (ret.result=="success") {
                    	new TipBox({type:'success',str:"创建成功",hasBtn:true});
                    }
                    else
                    {
            ...
            <div class="tabBody mb10">
                <div class="bodyLi bodyActive">
                    <div class="win-input mb10">
                        ...
                        <input type="text" id="name" class="text-full" placeholder="请输入" >
                    </div>
                    ...
                    <div class="win-input mb10">
                        ...
                        <input type="text" id="description" class="text-full" placeholder="请输入" >
                    </div>

                    
                     <div class="win-input mb10">
                        <span class="input-name">密码</span>
                        <input type="password" id="password1" class="text-full" placeholder="请输入" >
                    </div>
                    <div class="win-input mb10">
                        <span class="input-name">确认密码</span>
                        <input type="password" id="password2" class="text-full" placeholder="请输入" >
                    </div>
                </div>
